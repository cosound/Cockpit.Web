...
require(['NameConventionLoader', 'knockout', 'bootstrap', 'Portal', 'css!Styles/Default', 'KnockoutBindings/CanvasContext', 'KnockoutBindings/ClickPosition'], function (nameConventionLoader, knockout) {
